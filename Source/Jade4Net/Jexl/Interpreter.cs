...
namespace Jade4Net.Jexl
{
    public class Interpreter : ParserVisitor
    {
        /** The logger. */
        protected readonly Log logger;
        /** The uberspect. */
        protected readonly Uberspect uberspect;
        /** The arithmetic handler. */
        protected readonly JexlArithmetic arithmetic;
        /** The map of registered functions. */
        protected readonly Map<String, Object> functions;
        /** The map of registered functions. */
        protected Map<String, Object> functors;
        /** The context to store/retrieve variables. */
        protected readonly JexlContext context;
        /** Strict interpreter flag. Do not modify; will be made readonly/private in a later version. */
        protected bool strict;
        /** Silent intepreter flag.  Do not modify; will be made readonly/private in a later version. */
        protected bool silent;
        /** Cache executors. */
        protected readonly bool cache;
    ...
    private String[] parameters = null;
        ...
        protected static readonly Object[] EMPTY_PARAMS = new Object[0];
    ...
    public Object visit(ASTAndNode node, Object data)
    {
        ...
        try
        {
            bool leftValue = arithmetic.tobool(left);
            if (!leftValue)
            {
                return bool.FALSE;
            }
        ...
        {
            throw new JexlException(node.jjtGetChild(0), "bool coercion error", xrt);
        }
        Object right = node.jjtGetChild(1).jjtAccept(this, data);
        try
        {
            bool rightValue = arithmetic.tobool(right);
            if (!rightValue)
            {
                return bool.FALSE;
            }
        ...
        {
            throw new JexlException(node.jjtGetChild(1), "bool coercion error", xrt);
        }
        return bool.TRUE;
    }
...
public Object visit(ASTAssignment node, Object data)
{
    ...
    bool isRegister = last < 0 && register >= 0;
...
public Object visit(ASTEmptyFunction node, Object data)
{
    ...
    if (o instanceof Collection<?>) {
        return ((Collection <?>) o).isEmpty() ? bool.TRUE : bool.FALSE;
    }
    // Map isn't a collection
    if (o instanceof Map<?, ?>) {
        return ((Map <?, ?>) o).isEmpty() ? bool.TRUE : bool.FALSE;
    }
    return bool.FALSE;
}
...
public Object visit(ASTEQNode node, Object data)
{
    ...
    try
    {
        return arithmetic.equals(left, right) ? bool.TRUE : bool.FALSE;
    }
    catch (ArithmeticException xrt)
    {
        throw new JexlException(node, "== error", xrt);
...
public Object visit(ASTGENode node, Object data)
{
    ...
    try
    {
        return arithmetic.greaterThanOrEqual(left, right) ? bool.TRUE : bool.FALSE;
    }
    catch (ArithmeticException xrt)
    {
        throw new JexlException(node, ">= error", xrt);
...
public Object visit(ASTGTNode node, Object data)
{
    ...
    try
    {
        return arithmetic.greaterThan(left, right) ? bool.TRUE : bool.FALSE;
    }
    catch (ArithmeticException xrt)
    {
        throw new JexlException(node, "> error", xrt);
...
public Object visit(ASTERNode node, Object data)
{
    ...
    try
    {
        ...
        if (right instanceof java.util.regex.Pattern || right instanceof String) {
            return arithmetic.matches(left, right) ? bool.TRUE : bool.FALSE;
        }
        // left in right ? <=> right.contains(left) ?
        // try contains on collection
        if (right instanceof Set<?>) {
            return ((Set <?>) right).contains(left) ? bool.TRUE : bool.FALSE;
        }
        // try contains on map key
        if (right instanceof Map<?, ?>) {
            return ((Map <?, ?>) right).containsKey(left) ? bool.TRUE : bool.FALSE;
        }
        // try contains on collection
        if (right instanceof Collection<?>) {
            return ((Collection <?>) right).contains(left) ? bool.TRUE : bool.FALSE;
        }
        ...
        try
        {
            ...
            if (vm != null)
            {
                return arithmetic.tobool(vm.invoke(right, argv)) ? bool.TRUE : bool.FALSE;
            }
...
public Object visit(ASTIfStatement node, Object data)
{
    ...
    try
    {
        ...
        if (arithmetic.tobool(expression))
        {
...
public Object visit(ASTLENode node, Object data)
{
    ...
    try
    {
        return arithmetic.lessThanOrEqual(left, right) ? bool.TRUE : bool.FALSE;
    }
    catch (ArithmeticException xrt)
    {
        throw new JexlException(node, "<= error", xrt);
...
public Object visit(ASTLTNode node, Object data)
{
    ...
    try
    {
        return arithmetic.lessThan(left, right) ? bool.TRUE : bool.FALSE;
    }
    catch (ArithmeticException xrt)
    {
        throw new JexlException(node, "< error", xrt);
...
public Object visit(ASTNENode node, Object data)
{
    ...
    try
    {
        return arithmetic.equals(left, right) ? bool.FALSE : bool.TRUE;
    }
    catch (ArithmeticException xrt)
    {
        JexlNode xnode = findNullOperand(xrt, node, left, right);
...
public Object visit(ASTNRNode node, Object data)
{
    ...
    try
    {
        if (right instanceof java.util.regex.Pattern || right instanceof String) {
            // use arithmetic / pattern matching
            return arithmetic.matches(left, right) ? bool.FALSE : bool.TRUE;
        }
        // try contains on collection
        if (right instanceof Set<?>) {
            return ((Set <?>) right).contains(left) ? bool.FALSE : bool.TRUE;
        }
        // try contains on map key
        if (right instanceof Map<?, ?>) {
            return ((Map <?, ?>) right).containsKey(left) ? bool.FALSE : bool.TRUE;
        }
        // try contains on collection
        if (right instanceof Collection<?>) {
            return ((Collection <?>) right).contains(left) ? bool.FALSE : bool.TRUE;
        }
        // try a contains method (duck type set)
        try
        {
            ...
            if (vm != null)
            {
                return arithmetic.tobool(vm.invoke(right, argv)) ? bool.FALSE : bool.TRUE;
            }
            else if (arithmetic.narrowArguments(argv))
            {
                vm = uberspect.getMethod(right, "contains", argv, node);
...
public Object visit(ASTNotNode node, Object data)
{
    ...
    return arithmetic.tobool(val) ? bool.FALSE : bool.TRUE;
}
 ...
 */
private bool isTernaryProtected(JexlNode node)
{
...
public Object visit(ASTTernaryNode node, Object data)
{
    ...
    if (node.jjtGetNumChildren() == 3)
    {
        if (condition != null && arithmetic.tobool(condition))
        {
...
public Object visit(ASTWhileStatement node, Object data)
{
    ...
    while (arithmetic.tobool(expressionNode.jjtAccept(this, data)))
    {
        if (isCancelled())
        {
            throw new JexlException.Cancel(node);
