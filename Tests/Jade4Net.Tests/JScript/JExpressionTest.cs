...
namespace Jade.Tests.JScript
{
    public class JExpressionTest
    {
/*
            private Dictionary<String, Object> getDefaultModel() {
                Dictionary<String, Object> defaultModel = new Dictionary<String,Object>();
                defaultModel.Add("booleanTrue", true);
                defaultModel.Add("booleanFalse", false);
                defaultModel.Add("stringHallo", "hallo!");
                return defaultModel;
            }
            ...
            public void testAssignment() {
                ...
                try {
                    Esprime.getValue("dummy.text = 'michael'", context, root);
